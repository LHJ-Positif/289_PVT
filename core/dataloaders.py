...
class load_data_from_scratch(Dataset):
    ...
    def __getitem__(self, chunk_idx):
        ...
        # Modified to support pvtv2
        if self.visual_encoder in ['resnet', 'pvtv2']:  # Added pvtv2 here
            ...
            raise ValueError(
                """Input feature '%s' non supported. Use 'resnet', 'pvtv2' or 'i3d' instead.""" % self.visual_encoder)
