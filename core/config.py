...
input = {
    'project_path': '/home/hj3090/workspace/code/289_pvt_v2_b2_원본백업', #,os.getcwd()
    'data_path': '/home/hj3090/workspace/dataset/data_dcase2023_task3', # path to dataset
    'feature_path': '/home/hj3090/workspace/dataset/data_dcase2023_task3/features', # might want to save h5py (and scaler) somewhere else.
    'features': 'IV',
    'fps': 10,
    'fs': 24000, # Hz
...
training_param = {
    ...
    'visual_encoder_type': 'pvtv2', # choose between 'resnet' or 'i3d'
